...
const LoginPage = () => {
    ...
    return (
        <div className="min-h-[90vh] flex items-center justify-center p-4 sm:p-6 relative overflow-hidden">
            {/* Decorative blobs */}
            <div className="blob-1 -top-32 -left-32" />
            <div className="blob-2 -bottom-32 -right-32" />
                ...
                <div className="bg-white/80 backdrop-blur-xl rounded-3xl sm:rounded-[32px] shadow-soft border border-rose-100/60 p-6 sm:p-10 md:p-12">
                    ...
                    <div className="mt-8 sm:mt-10 text-center">
                        <p className="text-gray-400 text-sm sm:text-base">
                            Don't have an ID? <Link to="/register" className="text-rose-500 font-bold hover:underline hover:text-rose-600">Create one now.</Link>
                        </p>
                    </div>
                </div>
